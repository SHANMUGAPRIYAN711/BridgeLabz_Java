...
public class RideNavigation {
    ...
    public static void main(String[] args) {
        ...
        RideCar car = new RideCar("CAR101", "Shanmugapriyan", 15);
        RideBike bike = new RideBike("BIKE202", "Dhivya", 8);
        RideAuto auto = new RideAuto("AUTO303", "Dhana", 10);
